...
func GetMeanObliquityOfTheEcliptic(J float64) float64 {
	...
	ε := math.Mod(23.4392917-0.0130041667*J-0.00000016667*J*J+0.0000005027778*J*J*J, 360)
...
*/
func GetNutationInLongitudeOfTheEcliptic(L, l, Ω float64) float64 {
...
@see p.144 of Meeus, Jean. 1991. Astronomical algorithms. Richmond, Va: Willmann-Bell.
*/
func GetNutationInObliquityOfTheEcliptic(L, l, Ω float64) float64 {
...
*/
func GetArgumentOfLocalSiderealTimeForTransit(latitude, δ float64) float64 {
