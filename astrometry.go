...
*/
func GetHourAngle(ra, LST float64) float64 {
	ha := LST*15 - ra
...
*/
func GetAngularSeparation(coord1, coord2 Coordinate) float64 {
	x := cosx(coord1.Latitude)*sinx(coord2.Latitude) - sinx(coord1.Latitude)*cosx(coord2.Latitude)*cosx(coord2.Longitude-coord1.Longitude)

	y := cosx(coord2.Latitude) * sinx(coord2.Longitude-coord1.Longitude)

	z := sinx(coord1.Latitude)*sinx(coord2.Latitude) + cosx(coord1.Latitude)*cosx(coord2.Latitude)*cosx(coord2.Longitude-coord1.Longitude)
